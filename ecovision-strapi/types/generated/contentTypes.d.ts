...
export interface ApiDriverDriver extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    assigned_count: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    availability_schedule: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documents: Schema.Attribute.Media<
      ...
      true
    >;
    driverStatus: Schema.Attribute.Enumeration<
      ['available', 'unavailable', 'on_trip', 'off_duty', 'suspended']
    > &
    ...
    max_active_assignments: Schema.Attribute.Integer &
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    photo: Schema.Attribute.Media<
      ...
      true
    >;
    proofDistanceMeters: Schema.Attribute.Decimal;
    proofLatitude: Schema.Attribute.Decimal;
    proofLongitude: Schema.Attribute.Decimal;
    proofMedia: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    proofSubmittedAt: Schema.Attribute.DateTime;
    proofVerified: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wasteType: Schema.Attribute.Enumeration<
      [
        'General Waste',
        'Plastic',
        'Paper',
